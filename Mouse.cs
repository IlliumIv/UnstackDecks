...
namespace UnstackDecks
{
    public class Mouse
    {
        ...
        public const int MouseEventLeftClickDown = 0x02;
        public const int MouseEventLeftClickUp = 0x04;
        ...
        {
            mouse_event(MouseEventRightClickDown, 0, 0, 0, 0);
        }

        public static void RightMouseUp()
        {
            mouse_event(MouseEventRightClickUp, 0, 0, 0, 0);
        }
